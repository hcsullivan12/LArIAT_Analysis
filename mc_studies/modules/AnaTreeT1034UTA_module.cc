// ==========================================
// === modified version of AnaTreeT1034UC ===
// ==========================================
...
private:
  ...
  std::vector<std::string> InteractionPointSubType;  //<---Geant 4 Primary Interaction sub process
...
{
  fTreeName                 = pset.get< std::string >("TreeName", "anatreeuta");
