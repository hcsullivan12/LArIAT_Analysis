// ======================================
// === modified version of anatree uc ===
// ======================================
...
private:
  ...
  std::vector<std::string> InteractionPointSubType; //<--- Sub process type for Primary
...
//    (fSimulationProducerLabel);
  ...
  if(!isdata)
    ...
    for(unsigned int i = 0; i < geant_part.size(); ++i)
      ...
      interactionSubLabel.push_back(subclassifier.Classify(plist, geant_part[i]->TrackId());
