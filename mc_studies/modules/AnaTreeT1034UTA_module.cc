  ...
  if(!isdata)
    {
     ...
     InteractionPointSubType.push_back( subclassifier.Classify(plist, TrackId[i]) );
       ...
       if ((truetraj.KeyToProcess(couple.second)).find("pi-Inelastic")!= std::string::npos) InteractionPointType.push_back("pi-Inelastic");
       if ((truetraj.KeyToProcess(couple.second)).find("pi+Inelastic")!= std::string::npos) InteractionPointType.push_back("pi+Inelastic");
       if ((truetraj.KeyToProcess(couple.second)).find("CHIPSNuclearCaptureAtRest")!= std::string::npos) InteractionPointType.push_back("CHIPSNuclearCaptureAtRest");
       if ((truetraj.KeyToProcess(couple.second)).find("Decay")!= std::string::npos) InteractionPointType.push_back("Decay");
       if ((truetraj.KeyToProcess(couple.second)).find("CoulombScat")!= std::string::npos) InteractionPointType.push_back("ColoumbScat");
       if ((truetraj.KeyToProcess(couple.second)).find("hBertiniCaptureAtRest")!= std::string::npos) InteractionPointType.push_back("hBertiniCaptureAtRest");
		 }
	     }	
