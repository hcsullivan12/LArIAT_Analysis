...
// Wed May 15 09:14:06 2019 by ROOT version 6.10/04
// from TTree anatree/analysis tree
// found on file: anatree_100000e_piminus.root
//////////////////////////////////////////////////////////

#ifndef pi_minus_100000e_h
#define pi_minus_100000e_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[60];   //[nclus]
   Double_t        clusterttick[60];   //[nclus]
   Double_t        cluendwire[60];   //[nclus]
   Double_t        cluendtick[60];   //[nclus]
   Int_t           cluplane[60];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[16];   //[ntracks_reco]
   Double_t        trkvtxy[16];   //[ntracks_reco]
   Double_t        trkvtxz[16];   //[ntracks_reco]
   Double_t        trkendx[16];   //[ntracks_reco]
   Double_t        trkendy[16];   //[ntracks_reco]
   Double_t        trkendz[16];   //[ntracks_reco]
   Double_t        trkstartdcosx[16];   //[ntracks_reco]
   Double_t        trkstartdcosy[16];   //[ntracks_reco]
   Double_t        trkstartdcosz[16];   //[ntracks_reco]
   Double_t        trkenddcosx[16];   //[ntracks_reco]
   Double_t        trkenddcosy[16];   //[ntracks_reco]
   Double_t        trkenddcosz[16];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[16];   //[ntracks_reco]
   Double_t        trklength[16];   //[ntracks_reco]
   Double_t        trkmomrange[16];   //[ntracks_reco]
   Double_t        trkmommschi2[16];   //[ntracks_reco]
   Double_t        trkmommsllhd[16];   //[ntracks_reco]
   Int_t           ntrkhits[16];   //[ntracks_reco]
   Double_t        trkx[16][1000];   //[ntracks_reco]
   Double_t        trky[16][1000];   //[ntracks_reco]
   Double_t        trkz[16][1000];   //[ntracks_reco]
   Double_t        trkpitch[16][2];   //[ntracks_reco]
   Int_t           trkhits[16][2];   //[ntracks_reco]
   Double_t        trkdedx[16][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[16][2][1000];   //[ntracks_reco]
   Double_t        trkrr[16][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[16][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[16][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[16][2];   //[ntracks_reco]
   Double_t        trkpida[16][2];   //[ntracks_reco]
   Int_t           nTrajPoint[16];   //[ntracks_reco]
   Double_t        pHat0_X[16][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[16][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[16][1000];   //[ntracks_reco]
   Double_t        trjPt_X[16][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[16][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[16][1000];   //[ntracks_reco]
   Int_t           trkg4id[16];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[942];   //[nhits]
   Int_t           hit_wire[942];   //[nhits]
   Int_t           hit_channel[942];   //[nhits]
   Double_t        hit_peakT[942];   //[nhits]
   Double_t        hit_charge[942];   //[nhits]
   Double_t        hit_ph[942];   //[nhits]
   Double_t        hit_tstart[942];   //[nhits]
   Double_t        hit_tend[942];   //[nhits]
   Int_t           hit_trkid[942];   //[nhits]
   Int_t           hit_trkkey[942];   //[nhits]
   Int_t           hit_clukey[942];   //[nhits]
   Int_t           hit_pk[942];   //[nhits]
   Int_t           hit_t[942];   //[nhits]
   Int_t           hit_ch[942];   //[nhits]
   Int_t           hit_fwhh[942];   //[nhits]
   Double_t        hit_rms[942];   //[nhits]
   Double_t        hit_nelec[942];   //[nhits]
   Double_t        hit_energy[942];   //[nhits]
   Float_t         hit_dQds[942];   //[nhits]
   Float_t         hit_dEds[942];   //[nhits]
   Float_t         hit_ds[942];   //[nhits]
   Float_t         hit_resrange[942];   //[nhits]
   Float_t         hit_x[942];   //[nhits]
   Float_t         hit_y[942];   //[nhits]
   Float_t         hit_z[942];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[4332];   //[maxTrackIDE]
   Double_t        IDEPos[4332][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[279];   //[geant_list_size]
   Double_t        Eng[279];   //[geant_list_size]
   Double_t        Px[279];   //[geant_list_size]
   Double_t        Py[279];   //[geant_list_size]
   Double_t        Pz[279];   //[geant_list_size]
   Double_t        EndEng[279];   //[geant_list_size]
   Double_t        EndPx[279];   //[geant_list_size]
   Double_t        EndPy[279];   //[geant_list_size]
   Double_t        EndPz[279];   //[geant_list_size]
   Double_t        StartPointx[279];   //[geant_list_size]
   Double_t        StartPointy[279];   //[geant_list_size]
   Double_t        StartPointz[279];   //[geant_list_size]
   Double_t        EndPointx[279];   //[geant_list_size]
   Double_t        EndPointy[279];   //[geant_list_size]
   Double_t        EndPointz[279];   //[geant_list_size]
   Int_t           Process[279];   //[geant_list_size]
   Int_t           NumberDaughters[279];   //[geant_list_size]
   Int_t           Mother[279];   //[geant_list_size]
   Int_t           TrackId[279];   //[geant_list_size]
   Int_t           process_primary[279];   //[geant_list_size]
   ...
   pi_minus_100000e(TTree *tree=0);
   virtual ~pi_minus_100000e();
...
#ifdef pi_minus_100000e_cxx
pi_minus_100000e::pi_minus_100000e(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("anatree_100000e_piminus.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("anatree_100000e_piminus.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("anatree_100000e_piminus.root:/anatree");
...
pi_minus_100000e::~pi_minus_100000e()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t pi_minus_100000e::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t pi_minus_100000e::LoadTree(Long64_t entry)
{
...
void pi_minus_100000e::Init(TTree *tree)
{
...
Bool_t pi_minus_100000e::Notify()
{
...
void pi_minus_100000e::Show(Long64_t entry)
{
...
Int_t pi_minus_100000e::Cut(Long64_t entry)
{
...
#endif // #ifdef pi_minus_100000e_cxx
